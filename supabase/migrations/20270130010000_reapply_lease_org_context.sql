-- Re-apply lease creation functions with org_id derivation from property or unit
...
BEGIN
  ...
  IF v_unit_id IS NOT NULL THEN
    ...
    IF v_property_id IS NOT NULL AND v_org_id IS NULL THEN
      SELECT org_id INTO v_org_id FROM public.properties WHERE id = v_property_id;
    END IF;
  END IF;
