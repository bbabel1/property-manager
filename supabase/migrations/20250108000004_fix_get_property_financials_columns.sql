-- Fix get_property_financials to use correct columns from properties table
-- The balance, deposits_held_balance, and prepayments_balance columns don't exist
-- Use cash_balance instead and default deposits/prepayments to 0
