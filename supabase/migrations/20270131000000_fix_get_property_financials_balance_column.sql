-- Fix get_property_financials to use cash_balance instead of non-existent balance column
-- The balance column doesn't exist on properties table; use cash_balance as fallback
