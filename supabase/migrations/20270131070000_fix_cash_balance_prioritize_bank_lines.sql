-- Fix cash balance calculation to prioritize bank lines over payments_total
-- When bank lines exist, always use them instead of falling back to payments_total
-- This ensures cash balance reflects actual bank account balances
