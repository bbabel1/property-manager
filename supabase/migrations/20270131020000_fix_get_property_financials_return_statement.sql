-- Fix get_property_financials to properly return the result using RETURN statement
-- The SELECT statement needs to be assigned to a variable and then returned
