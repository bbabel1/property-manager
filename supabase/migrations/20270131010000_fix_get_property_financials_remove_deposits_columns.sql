-- Fix get_property_financials to remove references to non-existent deposits_held_balance and prepayments_balance columns
-- These columns exist on units table, not properties table
