-- Ensure accounts receivable lines are not treated as bank cash in get_property_financials
    ...
    raw_lines as (
        ...
        where tl.date <= p_as_of
          and (
            ...
            -- Include transaction_lines posted to the property's configured operating bank GL account
...
'Returns property financials with cash balance calculated from bank GL transaction_lines. Prevents accounts receivable lines from being classified as bank cash and limits bank lines to the property''s configured operating bank GL account.';
