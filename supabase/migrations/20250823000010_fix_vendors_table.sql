...
-- Migration: 20250823000008_fix_vendors_table.sql
-- Description: Drops the simplified vendors table and recreates it with proper Buildium structure

-- Drop the existing simplified vendors table
...
DO $$
BEGIN
    RAISE NOTICE 'Fixed vendors table structure with proper Buildium integration';
END $$;
