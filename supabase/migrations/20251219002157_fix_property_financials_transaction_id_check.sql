-- Fix get_property_financials to check transaction_id is not null before aggregating
-- This prevents null transaction_ids from being included in deposit/prepay arrays
