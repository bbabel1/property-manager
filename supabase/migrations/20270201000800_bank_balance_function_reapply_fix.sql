-- Re-apply the corrected bank balance function definition.
--
-- Why: The remote database has migration version 20280402123000 recorded as applied,
-- but the deployed function body is still the older implementation that can reference
-- v_property before assignment when p_property_id is null, causing:
--   55000: record "v_property" is not assigned yet
--
-- This migration creates/replaces ONLY the function body (no permission changes).
