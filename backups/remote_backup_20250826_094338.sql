...
CREATE TABLE IF NOT EXISTS "public"."bank_accounts" (
    ...
    "check_layout_type" character varying(50),
    "signature_heading" character varying(255),
    "fractional_number" character varying(255),
    "bank_information_line1" character varying(255),
    "bank_information_line2" character varying(255),
    "bank_information_line3" character varying(255),
    "bank_information_line4" character varying(255),
    "bank_information_line5" character varying(255),
    "company_information_line1" character varying(255),
    "company_information_line2" character varying(255),
    "company_information_line3" character varying(255),
    "company_information_line4" character varying(255),
    "company_information_line5" character varying(255),
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "public"."contacts" (
    ...
    "primary_country" "text" DEFAULT 'USA'::"text",
...
CREATE TABLE IF NOT EXISTS "public"."transaction_lines" (
    ...
    "lease_id" bigint,
    "buildium_lease_id" integer,
    CONSTRAINT "journal_entries_posting_type_check" CHECK ((("posting_type")::"text" = ANY ((ARRAY['Credit'::character varying, 'Debit'::character varying])::"text"[])))
);
...
CREATE INDEX "bank_accounts_country_idx" ON "public"."bank_accounts" USING "btree" ("country");
