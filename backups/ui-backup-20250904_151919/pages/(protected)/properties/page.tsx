...
export default function PropertiesPage() {
  ...
  const filtered = properties.filter((p) => {
    ...
    const matchesType = typeFilter === 'All Types' || p.rentalSubType === typeFilter
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="space-y-1">
                            ...
                            <div className="text-xs text-muted-foreground">
                              <span className="text-success">22</span>/<span className="text-muted-foreground">2</span>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-center">
              ...
              <div className="px-6 py-4 border-t border-border">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-6 text-sm text-muted-foreground">
                    <span>Total Units: <span className="font-medium text-foreground">80</span></span>
                    <span>Occupied: <span className="font-medium text-success">74</span></span>
                    <span>Available: <span className="font-medium text-foreground">6</span></span>
                  </div>
                </div>
              </div>
            </>
