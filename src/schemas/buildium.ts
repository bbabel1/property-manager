...
export const BuildiumBankAccountUpdateSchema = z.object({
  ...
  Description: z.string().optional(),
  BankAccountType: z
    .enum(['Checking', 'Savings', 'MoneyMarket', 'CertificateOfDeposit'])
    .optional(),
...
export const BuildiumApplianceServiceHistoryCreateSchema = z.object({
  ...
  ServiceType: z.enum(['Maintenance', 'Repair', 'Replacement', 'Inspection', 'Other']),
  Description: z.string().min(1, 'Description is required'),
...
export const BuildiumLeaseCreateSchema = z.object({
  ...
  RenewalOfferStatus: z
    .enum(['NotOffered', 'Offered', 'Accepted', 'Declined', 'Expired'])
    .optional(),
  Notes: z.string().optional(),
});
...
export const BuildiumLeaseChargeCreateSchema = z.object({
  ...
  Description: z.string().min(1, 'Description is required'),
  ChargeType: z.enum(['Rent', 'LateFee', 'NSFFee', 'PetFee', 'Utility', 'Other']),
  IsRecurring: z.boolean().default(false),
...
export const BuildiumLeaseTransactionCreateSchema = z.object({
  TransactionType: z.enum(['Charge', 'Payment', 'Credit', 'Adjustment', 'Refund', 'ApplyDeposit']),
  ...
  PayeeTenantId: z.number().int().optional(),
  CheckNumber: z.string().optional(),
  ...
  AddressOption: z.enum(['Current', 'Tenant', 'Forwarding', 'Custom']).optional(),
  CustomAddress: z.string().optional(),
  DepositAccountId: z.number().int().optional(),
});
...
export const BuildiumRecurringTransactionUpdateSchema =
  BuildiumRecurringTransactionCreateSchema.partial();
...
export const BuildiumLeaseChargeUpdateSchema = z.object({
  ...
  Description: z.string().min(1, 'Description is required').optional(),
  ChargeType: z.enum(['Rent', 'LateFee', 'NSFFee', 'PetFee', 'Utility', 'Other']).optional(),
  IsRecurring: z.boolean().optional(),
  RecurringFrequency: z.enum(['Monthly', 'Weekly', 'Yearly']).optional(),
  Notes: z.string().optional(),
});
...
export const BuildiumOwnerRequestCreateSchema = z.object({
  ...
  RequestType: z.enum(['Maintenance', 'Improvement', 'Inspection', 'Other']).optional(),
...
export const BuildiumOwnerContributionRequestUpdateSchema = z.object({
  ...
  ContributionPercentage: z
    .number()
    .min(0)
    .max(100, 'Contribution percentage must be between 0 and 100')
    .optional(),
  Notes: z.string().optional(),
...
// Buildium File Upload Schema (Legacy - for backwards compatibility)
...
const shareScopeBoolean = z.boolean().optional();
const shareScopeIdArray = z.array(z.number().int()).optional();

const buildiumShareScopeSchema = z
  .object({
    Tenants: shareScopeBoolean,
    RentalOwners: shareScopeBoolean,
    RentalOwner: shareScopeBoolean,
    AssociationOwners: shareScopeBoolean,
    BoardMembers: shareScopeBoolean,
    Committee: shareScopeBoolean,
    AllResidents: shareScopeBoolean,
    AllRentalOwners: shareScopeBoolean,
    WebsiteVisitors: shareScopeBoolean,
    Vendor: shareScopeBoolean,
    PropertyIds: shareScopeIdArray,
    RentalOwnerIds: shareScopeIdArray,
  })
  .partial()
  .optional();

export const BuildiumFileShareSettingsUpdateSchema = z
  .object({
    Account: z
      .object({
        AllResidents: shareScopeBoolean,
      ...
      .partial()
      .optional(),
    Rental: buildiumShareScopeSchema,
    RentalUnit: buildiumShareScopeSchema,
    Lease: buildiumShareScopeSchema,
    Tenant: buildiumShareScopeSchema,
    RentalOwner: buildiumShareScopeSchema,
    Association: buildiumShareScopeSchema,
    AssociationUnit: buildiumShareScopeSchema,
    OwnershipAccount: buildiumShareScopeSchema,
    AssociationOwner: buildiumShareScopeSchema,
    Vendor: buildiumShareScopeSchema,
    Committee: buildiumShareScopeSchema,
  })
  .refine(
    (value) => Object.values(value).some((scope) => scope && Object.keys(scope).length > 0),
    'At least one sharing scope must be provided',
  );
...
export type BuildiumBulkBillPaymentCreateInput = z.infer<
  typeof BuildiumBulkBillPaymentCreateSchema
>;
export type BuildiumGeneralLedgerEntryCreateInput = z.infer<
  typeof BuildiumGeneralLedgerEntryCreateSchema
>;
export type BuildiumGeneralLedgerEntryUpdateInput = z.infer<
  typeof BuildiumGeneralLedgerEntryUpdateSchema
>;
export type BuildiumGeneralLedgerAccountCreateInput = z.infer<
  typeof BuildiumGeneralLedgerAccountCreateSchema
>;
export type BuildiumGeneralLedgerAccountUpdateInput = z.infer<
  typeof BuildiumGeneralLedgerAccountUpdateSchema
>;

export type BuildiumPropertyPreferredVendorsUpdateInput = z.infer<
  typeof BuildiumPropertyPreferredVendorsUpdateSchema
>;
export type BuildiumPropertyAmenitiesUpdateInput = z.infer<
  typeof BuildiumPropertyAmenitiesUpdateSchema
>;
export type BuildiumPropertyEPaySettingsUpdateInput = z.infer<
  typeof BuildiumPropertyEPaySettingsUpdateSchema
>;
...
export type BuildiumPropertyImageOrderUpdateInput = z.infer<
  typeof BuildiumPropertyImageOrderUpdateSchema
>;
export type BuildiumPropertyVideoImageCreateInput = z.infer<
  typeof BuildiumPropertyVideoImageCreateSchema
>;
...
export type BuildiumApplianceServiceHistoryCreateInput = z.infer<
  typeof BuildiumApplianceServiceHistoryCreateSchema
>;
...
export type BuildiumLeaseTransactionCreateInput = z.infer<
  typeof BuildiumLeaseTransactionCreateSchema
>;
export type BuildiumLeaseTransactionUpdateInput = z.infer<
  typeof BuildiumLeaseTransactionUpdateSchema
>;
export type BuildiumRecurringTransactionCreateInput = z.infer<
  typeof BuildiumRecurringTransactionCreateSchema
>;
export type BuildiumRecurringTransactionUpdateInput = z.infer<
  typeof BuildiumRecurringTransactionUpdateSchema
>;
export type BuildiumTaskHistoryUpdateInput = z.infer<typeof BuildiumTaskHistoryUpdateSchema>;
export type BuildiumTaskHistoryFileUploadInput = z.infer<
  typeof BuildiumTaskHistoryFileUploadSchema
>;
...
export type BuildiumOwnerContributionRequestUpdateInput = z.infer<
  typeof BuildiumOwnerContributionRequestUpdateSchema
>;
export type BuildiumResidentRequestCreateInput = z.infer<
  typeof BuildiumResidentRequestCreateSchema
>;
export type BuildiumResidentRequestUpdateInput = z.infer<
  typeof BuildiumResidentRequestUpdateSchema
>;
...
export type BuildiumFileUploadRequestInput = z.infer<typeof BuildiumFileUploadRequestSchema>;
...
export type BuildiumFileShareSettingsUpdateInput = z.infer<
  typeof BuildiumFileShareSettingsUpdateSchema
>;
...
export type BuildiumPartialPaymentSettingsUpdateInput = z.infer<
  typeof BuildiumPartialPaymentSettingsUpdateSchema
>;
...
export const BuildiumSchemas = {
  ...
  FileUploadRequest: BuildiumFileUploadRequestSchema,
...
export type BuildiumPropertyCreateEnhancedInput = z.infer<
  typeof BuildiumPropertyCreateEnhancedSchema
>;
export type BuildiumPropertyUpdateEnhancedInput = z.infer<
  typeof BuildiumPropertyUpdateEnhancedSchema
>;
...
export type BuildiumBankAccountCreateEnhancedInput = z.infer<
  typeof BuildiumBankAccountCreateEnhancedSchema
>;
