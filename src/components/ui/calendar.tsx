  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption: "flex items-center justify-between text-foreground",
        ...
        head_row: "grid grid-cols-7 uppercase tracking-wide text-muted-foreground",
        ...
        day: "inline-flex h-9 w-9 items-center justify-center rounded-full text-foreground transition-colors hover:bg-primary/10 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40",
        day_range_start:
        ...
        footer: "border-t border-border/70 px-3 pb-2 pt-2",
        ...classNames,
      }}
      {...props}
    />
