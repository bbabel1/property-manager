    ...
    <div className="space-y-6">
      ...
      {vendors.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-6">Add contractors, service providers, and other vendors to manage property maintenance.</p>
          <Button>
            <Plus className="w-4 h-4 mr-2" />
      ...
      {vendors.length > 0 && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {vendors.map((vendor) => (
            <div key={vendor.id} className="bg-card rounded-lg border p-6 hover:shadow-md transition-shadow">
