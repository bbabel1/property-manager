...
export async function GET(
  ...
  try {
    ...
    const response = await buildiumFetch('GET', `/rentals/leases/${buildiumLeaseId}/transactions/charges/${chargeId}`, undefined, undefined, undefined);
...
export async function PUT(
  ...
  try {
    ...
    // Make request to Buildium API
    const response = await buildiumFetch('PUT', `/rentals/leases/${buildiumLeaseId}/transactions/charges/${chargeId}`, undefined, validatedData, undefined);
