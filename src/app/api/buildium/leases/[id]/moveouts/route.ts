...
export async function GET(
  ...
  try {
    ...
    const buildiumUrl = `${process.env.BUILDIUM_BASE_URL}/rentals/leases/${id}/moveouts?${queryParams.toString()}`;
...
export async function POST(
  ...
  try {
    ...
    // Make request to Buildium API
    const buildiumUrl = `${process.env.BUILDIUM_BASE_URL}/rentals/leases/${id}/moveouts`;
