...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await buildiumFetch('GET', '/tasks/categories', queryParams, undefined, orgId);
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Make request to Buildium API
    const response = await buildiumFetch('POST', '/tasks/categories', undefined, validatedData, orgId);
