...
const resolveBuildiumAccountingEntityType = (
  raw?: string | null,
): BuildiumAccountingEntityType => {
...
const syncJournalEntryToBuildium = async (options: BuildiumSyncOptions): Promise<number> => {
